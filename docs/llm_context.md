...
| `transactional.py` | DuckDB-native large tables (orders 60.9M, shipments 69.9M, inventory 99.2M); Python for small tables. v0.79.2: shipment weight computed from `quantity * raw_products.weight_kg` (was bin capacity 20,000 kg/slot). |
